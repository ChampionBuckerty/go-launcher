...
export function CanWePatch():Promise<boolean>;
...
export function NostalgiaSettingsJsonPath():Promise<string>;
...
export function ReadNostalgiaSettingsJson():Promise<main.NostalgiaCustomSettings>;
